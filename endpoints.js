...
export const urlGetTariffPlanForPayerAndGetPayerBillAgreement=`${baseURL}/api/AssignedPlan/GetTariffPlanForPayerAndGetPayerBillAgreement`;
export const urlDeleteSelectedAssignedPlan=`${baseURL}/api/AssignedPlan/DeleteSelectedAssignedPlan`;
export const urlGetPriceTariffsAddnew=`${baseURL}/api/AssignedPlan/GetPriceTariffs`;
export const urlGetSaveNewAuthorisation=`${baseURL}/api/AssignedPlan/SaveNewAuthorisation`;
