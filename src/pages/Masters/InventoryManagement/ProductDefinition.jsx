...
import { EditOutlined, DownOutlined, DeleteOutlined, PlusOutlined, PlusCircleOutlined } from '@ant-design/icons';
import Layout from 'antd/es/layout/layout';
import { Spin, Skeleton, Tree, Typography, Modal, ConfigProvider, Select, Button, Form, Input, Row, Col, DatePicker, Card, Divider, Popconfirm, Table, Checkbox, message } from 'antd';
import dayjs from 'dayjs';
import TextArea from 'antd/es/input/TextArea';
import { urlProductDefinitionIndex, urlGetList, urlGetProductClassification, urlUpdateProductClassification, urlShowEditClassification, urlDeleteProductClassification } from '../../../../endpoints';
...
const ProductDefinition = () => {
    ...
    useEffect(() => {
        ...
        try {
            customAxios.get(urlProductDefinitionIndex, {}).then((response) => {
                ...
                const processedData = processTreeData(apiData.ProductGroup);
    ...
    const onSelect = (selectedKeys, info) => {
        debugger         
        customAxios.get(`${urlGetProductClassification}?ProductGroupId=${info.node.key}`).then((response) => {
            debugger;
            const apiData = response.data;
            // if (apiData === 'Failure') {
            //     setIsModalOpen(false);
