...
// import { urlCreateAcknowledgeReturn/*, urlAutocompleteProduct, urlAddNewPurchaseOrder*/ } from '../../../endpoints';
            ...
            <Col className="gutter-row" span={6}>
              <div>
                <Form.Item label="PO Date" name="PODate">
                  <DatePicker defaultValue={dayjs(`${currentDate}`)} style={{ width: '100%' }} disabled format="DD-MM-YYYY" /*format={dateFormat}*/ />
                </Form.Item>
              </div>
            </Col>
            <Col className="gutter-row" span={6}>
...
export default CreateAcknowledgeReturn;
