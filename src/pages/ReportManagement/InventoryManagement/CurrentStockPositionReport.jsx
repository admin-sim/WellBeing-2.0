import { Form, Button, Row, Col, Layout, Spin, Select } from "antd";
import {
...
const CurrentStockPositionReport = () => {
  ...
  const onFinish = async (values) => {
    ...
    const request = {
      FacilityId: 1,
      ProductId:
        values.Currentstockposition == "All" ? 0 : values.Currentstockposition,
        ...
        >
          ...
          >
            <Row gutter={16} style={{ marginBottom: "12px" }}>
              ...
              <ColWithSixSpan>
                <Form.Item
                  name="Currentstockposition"
                  label="Current stock position as On"
                  rules={[
                    {
                      required: true,
                      message: "Please select",
