...
const StockExpiryReport = () => {
    ...
    return (
        <Layout style={{ width: "100%" }}>
            ...
            >
                <PageHeader title={"Stock Expiry Report"} button={false} />
                <div
                    style={{
                        padding: "1rem",
                        borderRadius: "0.5rem",
                ...
                >
                    ...
                    >
                        <Row gutter={16} style={{ marginBottom: "12px" }}>
                            ...
                            <ColWithSixSpan>
                                <Form.Item name="ViewStock" label="View Stock"
                                    rules={[
                                        {
                                            required: true,
                                ...
                                >
                                    <Select allowClear>
                                        ...
                                        <Select.Option key={90} value={90}>Expiring In 3 Month</Select.Option>
                                        <Select.Option key={180} value={180}>Expiring In 6 Month</Select.Option>
