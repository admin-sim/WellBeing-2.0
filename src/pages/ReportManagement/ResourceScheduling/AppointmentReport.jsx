...
function AppointmentReport() {
  ...
  const onFinish = async (values) => {
    ...
    const request = {
      FacilityId: 1,
      UhId: values.UhId,
      FDate: values.FromDate.format("DD-MM-YYYY"),
      TDate: values.ToDate.format("DD-MM-YYYY"),
      AppointmentReferenceNo:
        values.AppointmentReference == ""
          ? undefined
          : values.AppointmentReference,
  ...
  async function fetchReport(request) {
    const response = await fetch(
      "https://192.168.29.254:808/api/ReportsApi/GetAppointmentsRpt",
      {
        method: "POST",
        headers: {
  ...
  return (
    <Layout style={{ width: "100%" }}>
      ...
      >
        <PageHeader title={"Appointment Report"} button={false} />
        <div
          style={{
            padding: "1rem",
            borderRadius: "0.5rem",
          ...
          >
            <Row gutter={16} style={{ marginBottom: "12px" }}>
              ...
              <ColWithSixSpan>
                ...
                >
                  <Select placeholder="Status" defaultValue="Booked">
                    <Select.Option key="Booked" value="Booked"></Select.Option>
                    <Select.Option
                      key="Cancelled"
                      value="Cancelled"
                    ></Select.Option>
                    <Select.Option key="NoShow" value="NoShow"></Select.Option>
                    <Select.Option
                      key="Confirmed"
                      value="Confirmed"
                    ></Select.Option>
