...
import {
  ...
  urlSearchPatientsForLabRadiology,
  urlSearchUHID,
} from "../../../endpoints.js";
...
//   };
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await customAxios.get(urlSearchPatientsForLabRadiology, {
  ...
  return (
    <Layout style={{ width: "100%" }}>
      ...
      >
        <PageHeader title={"Radiology Dashboard"} button={false} />
        <div
          style={{
            padding: "1rem",
            borderRadius: "0.5rem",
