...
import {
  ...
  urlUpdateAuthorisationLineChargeParameterAsync,
} from "../../../../endpoints";

import dayjs from "dayjs";
import { debounce } from "lodash";

function EditAssignedPlanModal({
  options,
  open,
  handleClose,
  editedAuthlineId,
  ...
  useEffect(() => {
    if (linedata) {
      form.setFieldsValue({
        ...
        DenialCode: linedata.DenialCode,
        Qty: linedata.Qty,
        AmtIndicator: linedata.AmtIndicator,
        Value: linedata.Value,
        Priority: linedata.Priority,
        AmtRequested: linedata.AmtRequested,
        AmtDeductible: linedata.AmtDeductible,
        CoverageType: linedata.CoverageType,
        CoverageBy: linedata.CoverageBy,
        MaxCoverageAmt: linedata.MaxCoverageAmt,
        ApprovalCode: linedata.ApprovalCode,
  ...
  return (
    <div>
      <Spin spinning={loading}>
        <Modal
          title="Edit Authorisation Line Details"
          open={open}
          maskClosable={false}
          footer={null}
...
export default EditAssignedPlanModal;
